...
mrp.production.cad_conditionnement passe de Char à Many2one(uom.uom) :
    ...
    cr.execute(
        ...
        SELECT 1
         ...
         WHERE table_name = 'mrp_production'
           AND column_name = 'cad_conditionnement'
           AND data_type <> 'integer'
        """
    )
    if cr.fetchone():
        cr.execute("ALTER TABLE mrp_production DROP COLUMN cad_conditionnement")
