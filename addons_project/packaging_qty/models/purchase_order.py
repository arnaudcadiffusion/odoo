...
class PurchaseOrderLine(models.Model):
    ...
    # def _write_pack_qty(self):
    #     for record in self:
    #         if record.product_packaging_id:
    #             q = record._compute_packaging_amount()
    #             record.product_qty = record.packaging_qty * q

    # # PO_Line 的pack数量自动计算
    # @api.depends('product_qty','product_packaging_id','product_uom')
